...
| View formatter | `view-formatter.html`, `view-formatter.js`, `getViewFormatContext.js`; `background.js` installs formatter-tab-scoped iframe rules |
