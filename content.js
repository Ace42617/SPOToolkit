...
const LISTS_LAUNCHER_CSS =
  "#" + LISTS_LAUNCHER_ID + "{position:fixed;bottom:20px;right:20px;z-index:2147483646;font-family:'Segoe UI',sans-serif;transition:opacity .15s ease-out;}" +
  "#" + LISTS_LAUNCHER_ID + ".sp-toolkit-launcher-rolled-up{opacity:0;pointer-events:none;}" +
  "#" + LISTS_LAUNCHER_ID + " .sp-toolkit-lists-btn{width:48px;height:48px;border-radius:50%;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;padding:0;" +
  ...
  "#" + LISTS_LAUNCHER_ID + " .sp-toolkit-lists-btn .sp-toolkit-launcher-compass{width:24px;height:24px;display:block;flex-shrink:0;transition:transform .25s ease;}" +
  ...
  "#" + LISTS_LAUNCHER_PANEL_ID + ".sp-toolkit-lists-panel-dark{background:#181b23;color:#fff;border:1px solid rgba(255,255,255,.08);}" +
  ...
  "#" + LISTS_LAUNCHER_PANEL_ID + " .sp-toolkit-contents-table .sp-toolkit-row-settings{width:40px;text-align:center;vertical-align:middle;}" +
  ...
  "#" + LISTS_LAUNCHER_PANEL_ID + " .sp-toolkit-contents-table th[data-column=\"settings\"]{cursor:default;width:40px;}" +
