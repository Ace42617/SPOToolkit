// Injected: fetches list columns for current list via REST; returns siteUrl + listId for FldEdit links in the popup.
(function () {
        ...
        .then(function (data) {
          ...
          for (var i = 0; i < raw.length; i++) {
            ...
            columns.push({
              ...
              crawledProperty: crawledForInternal(internalName)
            });
          }
          window.postMessage({ __spcsv: true, type: "SPCSVSearchSchemaResult", columns: columns, error: null, siteUrl: siteUrl, listId: listId }, "*");
        });
    })
    .catch(function (err) {
