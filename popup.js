...
function moveUniversalSearchSelection(dir) {
  ...
  buttons.forEach((b) => b.classList.toggle("active", Number(b.dataset.idx) === universalSearchActive));
  const activeEl = buttons.find((b) => Number(b.dataset.idx) === universalSearchActive);
