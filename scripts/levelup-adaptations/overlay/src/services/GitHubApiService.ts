/**
 * GitHub API Service for sharing custom commands
...
export class GitHubApiService {
  ...
  private constructor() {
    // Default configuration - community commands repository
    this.config = {
...
*This issue was created automatically by a browser extension.*`;
  }
